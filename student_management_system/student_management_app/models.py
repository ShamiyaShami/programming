...
class Admin(models.Model):
    adm_id = models.AutoField(max_length=50, primary_key=True)
...
class Courses(models.Model):
    course_id = models.AutoField(max_length=50, primary_key=True)
...
class Student(models.Model):
    student_id = models.AutoField(max_length=50, primary_key=True)
    admin = models.OneToOneField(MainUser,on_delete=models.CASCADE)
    gender = models.CharField(max_length=50)
